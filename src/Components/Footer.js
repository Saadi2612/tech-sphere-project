...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10  pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] md:px-20 px-8 bg-[#AE88D1]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6"></p>
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>+92 (999) 999 99</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Website">
              <NavLink link="/#" label="Home" />
              <NavLink link="/#" label="Categories" />
              <NavLink link="/#" label="Featured Products" />
              <NavLink link="/#" label="User Strategy" />
            </LinkGroup>
            <LinkGroup header="Categories">
              <NavLink link="/#" label="Laptops" />
              <NavLink link="/#" label="Headphones" />
              <NavLink link="/#" label="Peripherals" />
              <NavLink link="/#" label="" />
            </LinkGroup>
            <LinkGroup header="About Us">
              <NavLink link="/#" label="About" />
              <NavLink link="/#" label="Customer Login" />
              <NavLink link="/#" label="Seller Login" />
              <NavLink link="/#" label="" />
            </LinkGroup>
